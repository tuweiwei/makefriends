   ...
   <a href="member/myAttention.action"><img src="images/side_gz.png" /></a>
    ...
    <a href="member/whoLookme.action"><img src="images/side_look.png" /></a>
     ...
     <div align="right" style="font-weight:bold; color:#333;padding:15px;" id="topmenu">
   		<a href="member/receiveBox.action" style="background-color: #e0ded2;padding: 15px;color: black;">会员收件箱</a>&nbsp;&nbsp;&nbsp;&nbsp;  
     ...
     <div id="advertise">
     <s:if test="#session.receiveEmailList==null">
      
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <font style="color: red;size: 15">对不起,您暂时没有收到任何邮件.</font>
     ...
     <form name="inboxForm" method="post">
       <table cellspacing="0"  border="1">
        <tbody>
          ...
          <s:iterator value="#session.receiveEmailList" id="list">
          <tr>
            <td>
