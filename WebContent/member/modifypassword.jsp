   ...
   <a href="member/myAttention.action"><img src="images/side_gz.png" /></a>
    ...
    <a href="member/whoLookme.action"><img src="images/side_look.png" /></a>
     ...
     <div align="right" style="font-weight:bold; color:#333;padding:15px;" id="topmenu">
   		<a href="member/memberinfo.jsp" >我的帐号</a>&nbsp;&nbsp;&nbsp;&nbsp;  
   		<a href="member/modifypassword.jsp" style="background-color: #e0ded2;padding: 15px;color: black;">修改密码</a>
     </div>
     </div>
     <br>
     &nbsp;&nbsp;登录密码长度为6-16个字符
     <div id="memberinfo" >
     <s:form action="member/modifypassword.action" method="post" name="modify">
      <table>
       <tbody>
         <tr>
          <td class="td">旧&nbsp;密&nbsp;码&nbsp;<font style="color: red;">*</font></td>
          <td>
          <input type="text" name="oldpassword" style="border: 1px solid #CCC8C4;width: 150px;height: 30px;"/>
         </td>
         </tr>
         <tr>
          <td class="td">新&nbsp;密&nbsp;码&nbsp;<font style="color: red;">*</font></td>
          <td>
          <input type="text" name="newpassword1" style="border: 1px solid #CCC8C4;width: 150px;height: 30px;"/>
         </td>
         </tr>
         <tr>
          <td class="td">再&nbsp;次&nbsp;输&nbsp;入&nbsp;<font style="color: red;">*</font></td>
          <td>
          <input type="text" name="newpassword2" style="border: 1px solid #CCC8C4;width: 150px;height: 30px;"/>
         </td>
         </tr>
         <tr>
         <td >
         ...
         <td >
          <a href="javascript:document.modify.submit()"><img src="images/save.png"/></a>
         </td>
         </tr>
         <tr>
           <td>
