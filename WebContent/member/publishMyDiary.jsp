   ...
   <a href="member/myAttention.action"><img src="images/side_gz.png" /></a>
    ...
    <a href="member/whoLookme.action"><img src="images/side_look.png" /></a>
     ...
     <div align="right" style="font-weight:bold; color:#333;padding:15px;" id="topmenu">
   		<a href="member/myDiary.action" >我的日记</a>&nbsp;&nbsp;&nbsp;&nbsp;  
   		<a href="member/publishMyDiary.jsp" style="background-color: #e0ded2;padding: 15px;color: black;">发表日记</a>
     </div>
     </div>
     <br>
     <div id="memberinfo" >
     <s:form action="member/addDiary.action" method="post" name="add">
        <table>
          <tbody>
            <tr>
              <td class="td">
              ...
              <td>
                <input type="text" name="title" style="border: 1px solid #ccc;height: 30px;width: 200px;"/>
              
              
                天气:
                <select name="weather" style="border: 1px solid #ccc;padding: 5px;">
                  <option value="无">
                   =请选择=
                  </option>
                  <option value="晴天">
                ...
                心情:
                <select name="mood" style="border: 1px solid #ccc;padding: 5px;">
                  <option value="无">
                   =请选择=
                  </option>
                  <option value="高兴">
            ...
            <tr>
              <td class="td">
             日记内容<font style="color: red;">*</font>
              </td>
              <td>
                <textarea rows="20" cols="70" style="border: 1px solid #ccc;" name="content"></textarea>
              </td>
            </tr>
            <tr>
            </tr><tr>
            ...
            <td>
             <a href="javascript:document.add.submit()" style="background-color: #D83473;color: white;padding:7px;">发表</a>
