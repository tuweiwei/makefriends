   ...
   <a href="member/myAttention.action"><img src="images/side_gz.png" /></a>
    ...
    <a href="member/whoLookme.action"><img src="images/side_look.png" /></a>
     ...
     <div align="right" style="font-weight:bold; color:#333;padding:15px;" id="topmenu">
   		<a href="member/myPhoto.jsp" >设置形象照</a>&nbsp;&nbsp;&nbsp;&nbsp;  
   		<a href="member/photoAlbum.jsp" >我的相册</a>
   		&nbsp;&nbsp;&nbsp;&nbsp; 
   		<a href="member/upLoadPhoto.jsp" style="background-color: #e0ded2;padding: 15px;color: black;">上传照片</a>
     </div>
     </div>
     <br>
     &nbsp;&nbsp;&nbsp;&nbsp; 请上传您的单人真实照片，要求五官清晰。
     ...
     <br>
     <div id="memberinfo" >
      <s:form action="member/uploadPhotos.action" enctype="multipart/form-data" name="up">
      <table>
       <tbody>
         <tr>
            <td class="td">
            选择照片<font style="color: red;">*</font>
            </td>
            <td>
