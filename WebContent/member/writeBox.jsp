   ...
   <a href="member/myAttention.action"><img src="images/side_gz.png" /></a>
    ...
    <a href="member/whoLookme.action"><img src="images/side_look.png" /></a>
     ...
     <div align="right" style="font-weight:bold; color:#333;padding:15px;" id="topmenu">
   		...
   		<a href="member/sendBox.action" >会员发件箱</a>
   		&nbsp;&nbsp;&nbsp;&nbsp;
   		<a href="member/writeBox.jsp" style="background-color: #e0ded2;padding: 15px;color: black;">写信件</a>
   		
     </div>
     </div>
     <br>
     <div id="memberinfo" >
     <s:form action="member/writeBox.action" method="post" name="add">
        <table>
          <tbody>
            <tr>
              <td class="td">
              收件人<font style="color: red;">*</font>
              
              </td>
              <td>
                <input type="text" name="receivename" style="border: 1px solid #ccc;height: 30px;width: 200px;"/>
             </td>
            </tr>
            <tr>
              <td class="td">
             内容<font style="color: red;">*</font>
              </td>
              <td>
                <textarea rows="20" cols="70" style="border: 1px solid #ccc;" name="emailcontent"></textarea>
              </td>
            </tr>
            <tr>
            </tr><tr>
            ...
            <td>
             <a href="javascript:document.add.submit()" style="background-color: #D83473;color: white;padding:7px;">发送</a>
             <a href="member/receiveBox.action" style="background-color: #D83473;color: white;padding:7px;">返回收件箱列表</a>
            </td>
            </tr>
          </tbody>
        </table>
