...
#top table tr td a:hover{
 ...
 #info_left{
     height: 270px; width: 170px; float: left;
 }
 #info_right{
  height: 270px; width: 85%; margin-left: 120px;
 }
 ...
 var t;
  ...
  <body>
     ...
     <div>
       ...
       游客欢迎您&nbsp;&nbsp;|<a href="../login.html" style="text-decoration: none;color: #FF6EC7">登陆网站</a>|<a href="../register.html" style="text-decoration: none;color: #FF6EC7">免费注册</a>
     </div>
     <div>
        <table>
          <tbody>
...
<div  id="side_right">
  ...
  <div id="info_right">
   <br> <br> <br>
   欢迎您:<a href="member/memberCenter.jsp" style="text-decoration: none;color: #FF6EC7;"><s:property value="#session.memberinfo.nickname"/></a>
   <br><br>
   积分:<s:property value="#session.memberinfo.point"/>
    <br><br>
    相册:<s:property value="#session.photoAlbumContent"/>张 <a href="member/upLoadPhoto.jsp" style="text-decoration: none;color: #FF6EC7;">上传</a>
    <br><br>
    <a href="main.jsp" style="text-decoration: none;color: #FF6EC7;">退出登录</a>
  </div>
  <div>
       &nbsp;&nbsp;&nbsp;
       <a href="member/memberCenter.jsp" style="background-color: #FF6EC7;padding:10 75 10 75;color: white;font-weight: bold;">进入个人中心</a>
...
<li><a href="member/memberListInfo.action?membername=<s:property value='#list.name'/>"><img src="<s:property value='#list.photo'/>" width="150" height="100" /><s:property value="#list.nickname"/></a></li>
</s:iterator>
</ul>
</div>	
	</div>
