   ...
   <a href="member/myAttention.action"><img src="images/side_gz.png" /></a>
    ...
    <a href="member/whoLookme.action"><img src="images/side_look.png" /></a>
     ...
     <div align="right" style="font-weight:bold; color:#333;padding:15px;" id="topmenu">
   		<a href="member/memberinfo.jsp" style="background-color: #e0ded2;padding: 15px;color: black;">我的帐号</a>&nbsp;&nbsp;&nbsp;&nbsp;  
   		<a href="member/modifypassword.jsp">修改密码</a>
     </div>
     </div>
     <br>
     <div id="memberinfo" >
      <table>
       <tbody>
         <tr>
          <td class="td">交友ID</td>
          <td><s:property value="#session.memberinfo.id"/></td>
         </tr>
         <tr>
         <tr>
       <tr>
          <td class="td">登录帐号</td>
          <td><s:property value="#session.memberinfo.name"/></td>
         </tr>
         <tr>
         <tr>
         <tr>
         ...
         <tr>
          <td class="td">可用积分</td>
          <td><s:property value="#session.memberinfo.point"/></td>
         </tr>
         <tr>
         <tr>
         <tr>
          <td class="td">注册时间</td>
          <td><s:property value="#session.memberinfo.registerdate"/></td>
         </tr>
         <tr>
         <tr>
         <tr>
          <td class="td">注册IP</td>
          <td><s:property value="#session.memberinfo.registerip"/></td>
         </tr>
         <tr>
         <tr>
         <tr>
          <td class="td">登录次数</td>
          <td><s:property value="#session.memberinfo.logincount"/></td>
         </tr>
         <tr>
         <tr>
         <tr>
          <td class="td">登录时间</td>
          <td><s:property value="#session.memberinfo.latestdate"/></td>
         </tr>
         <tr>
         <tr>
         <tr>
          <td class="td">登录IP</td>
          <td><s:property value="#session.memberinfo.ip"/></td>
         </tr>
       </tbody>
