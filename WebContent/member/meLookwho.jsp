   ...
   <a href="member/myAttention.action"><img src="images/side_gz.png" /></a>
    ...
    <a href="member/whoLookme.action"><img src="images/side_look.png" /></a>
     ...
     <div align="right" style="font-weight:bold; color:#333;padding:15px;" id="topmenu">
   		<a href="member/whoLookme.action" >谁看过我</a>&nbsp;&nbsp;&nbsp;&nbsp;  
   		<a href="member/meLookwho.action" style="background-color: #e0ded2;padding: 15px;color: black;">我看过谁</a>
     </div>
     </div>
     <br>
     <div style="border: 1px solid #ccc;width:760px;height: 50px;margin-left: 60px;background-color: #E9C2A6;">
     <br>
     &nbsp;&nbsp;我浏览过谁的资料共浏览过有<font style="color: red;"><s:property value="#session.meLookwhoListCount"/></font>个人
     </div>
     <div>
        <table>
          <tbody>
          <s:if test="#session.meLookwhoList==null">
          <br>
           <tr>
          ...
          <s:iterator value="#session.meLookwhoList" id="list">
            ...
            <td style="background-color: #F9F2E7;width: 627px;">
            &nbsp;&nbsp;&nbsp;&nbsp;<s:property value="#list.nickname"/> &nbsp;&nbsp;<s:property value="#list.address"/>
            <br>
            <br>
            <div align="right">
            <a href="member/writeBox.jsp">[写信件]</a>
            <a href="member/deleteMeLookWho.action?lookname=<s:property value='#list.name'/>">[删除记录]</a>
            </div>
            </td>
            </tr>
            </s:iterator>
