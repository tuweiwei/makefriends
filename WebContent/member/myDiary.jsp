  ...
  <head>
	...
	-->
     ...
     function delMessage(){
				...
				document.forms.inboxForm.action="<%=basePath%>member/deleteDiary.action";
  ...
  <body>
   ...
   <a href="member/myAttention.action"><img src="images/side_gz.png" /></a>
    ...
    <a href="member/whoLookme.action"><img src="images/side_look.png" /></a>
     ...
     <br>
     <div align="center">
     <s:if test="#session.DiaryList==null">
     对不起,您还没有发表日记.
     </s:if>
     <s:else>
       <div id="advertise">
       ...
       <table cellspacing="0"  border="1">
        <tbody>
          ...
          <s:iterator value="#session.DiaryList" id="list">
          <tr>
            <td>
            ...
            <td>
            <s:property value="#list.weather"/>
            </td>
            <td>
           <s:property value="#list.mood"/>
            </td>
            <td>
            <a href="member/diaryDetail.action?id=<s:property value="#list.id"/>" >查看日记</a>
            </td>
          </tr>
           </s:iterator>
          <tr>
